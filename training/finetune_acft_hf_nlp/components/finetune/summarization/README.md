# Summarization Finetune Component
...
2. _preprocess_output_ (URI_FOLDER, required)
    ...
    Path to the output folder of Summarization DataPreProcess component

3. _model_selector_output_ (URI_FOLDER, required)

    Path to the output directory of Summarization Model Import component
...
15. _metric_for_best_model_ (string, optional)
    ...
    Metric to be used to compare two different models. The possible metrics are loss, rouge1, rouge2, rougeL and rougeLsum. The default metric used is loss
