...
2. _preprocess_output_ (URI_FOLDER, required)
    ...
    Path to the output folder of [data preprocess component](../../preprocess/text_classification/README.md/#2-outputs)

3. _model_selector_output_ (URI_FOLDER, required)

    Path to the output directory of [model import component](../../model_selector/text_classification/model_selector_component.md/#2-outputs)
