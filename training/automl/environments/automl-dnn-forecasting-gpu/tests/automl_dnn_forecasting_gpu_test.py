...
"""Tests running a sample job in the automl-dnn-forecasting-gpu environment."""
import os
import time
...
def test_azureml_automl():
    ...
    env_name = "AutoML-Non-Prod-DNN-Forecasting-GPU"
    ...
    forecasting_job = automl.forecasting(
        ...
        experiment_name="AutoMLDNNForecastingGPUExperiment",
