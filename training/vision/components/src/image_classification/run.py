...
try:
    ...
    from azureml.contrib.automl.dnn.vision.classification import runner

from common.telemetry_utils import create_component_telemetry_wrapper


@create_component_telemetry_wrapper(Tasks.IMAGE_CLASSIFICATION)
def run():
    ...
    settings = {SettingsLiterals.TASK_TYPE: Tasks.IMAGE_CLASSIFICATION}
