...
"""Tests running a sample job in the tensorflow 2.7 environment."""
import os
import time
...
def test_tensorflow_2_7():
    """Tests a sample job using tensorflow 2.7 as the environment."""
    ...
    env_name = "tensorflow-2_7-cuda11"

    env_docker_context = Environment(
        build=BuildContext(path=this_dir / BUILD_CONTEXT),
        name=env_name,
        description="Tensorflow 2.7 environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the tensorflow 2_7 curated environment",
