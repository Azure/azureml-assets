...
def make_quota_client(make_completion_header_handler):
    def make(header_handler = make_completion_header_handler(), service_namespace: str = None, quota_audience: str = None, batch_pool:str = None, quota_estimator: str = "completion") -> QuotaClient:
