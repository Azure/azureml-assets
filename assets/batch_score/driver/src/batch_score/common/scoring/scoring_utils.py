...
def get_retriable_type(response_status: int,
    ...
    if response_status == 403:
        ...
        #  A bug in MIR returns 403 instead of 404
        #  when allow-listed object ids exist on traffic groups with zero capacity.
        return RetriableType.RETRY_ON_DIFFERENT_ENDPOINT
