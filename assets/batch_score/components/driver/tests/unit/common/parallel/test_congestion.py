...
"""This file contains unit tests for congestion."""

import os
import pandas as pd
import pytest

from src.batch_score.root.common.configuration.client_settings import ClientSettingsKey, NullClientSettingsProvider
from src.batch_score.root.common.parallel.congestion import (
    CongestionState,
    RequestMetrics,
...
class TestWaitTimeCongestionDetector:
    ...
    @pytest.mark.parametrize(
        "mock_get_client_setting, client_settings, "
    ...
    def test_init_env_var_overrides_client_setting_overrides_class_default(self,
        ...
        detector_class_default = WaitTimeCongestionDetector(client_settings_provider=NullClientSettingsProvider())
        ...
        detector_client_setting = WaitTimeCongestionDetector(client_settings_provider=NullClientSettingsProvider())
        ...
        detector_env_var = WaitTimeCongestionDetector(client_settings_provider=NullClientSettingsProvider())
    ...
    def test_unknown_congestion_case(self):
        """Test unknown congestion case."""
        congestion_detector = WaitTimeCongestionDetector(client_settings_provider=NullClientSettingsProvider())
    ...
    @pytest.mark.parametrize(
        "response_code, expected_congestion_state",
        ...
        [(r, CongestionState.UNKNOWN) for r in [400, 401, 403, 404, 500, 502, 503, 504]]
        + [(ScoringResultStatus.FAILURE, CongestionState.UNKNOWN)]
        + [(ScoringResultStatus.SUCCESS, CongestionState.FREE)],
    )
    ...
    def test_free_congestion_case(self):
    ...
    def test_saturated_congestion_case(self):
    ...
    def test_congested_congestion_case(self):
