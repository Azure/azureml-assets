This model is an optimized version of DeepSeek-R1-Distill-Qwen-7B to enable local inference with Foundry Local on GPUs. This model uses QuaRot and GPTQ quantization.
