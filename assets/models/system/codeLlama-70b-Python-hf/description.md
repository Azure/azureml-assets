# **Code Llama**
The Code Llama model is a collection of pretrained and fine-tuned generative text models ranging from 7 billion to 70 billion parameters, with a focus on code synthesis and understanding. It includes variants tailored for general code, Python-specific tasks, and instruction following for safer deployment. The model, developed by Meta, utilizes an auto-regressive transformer architecture and supports code completion, infilling, instructions/chat, and is specialized in Python.
