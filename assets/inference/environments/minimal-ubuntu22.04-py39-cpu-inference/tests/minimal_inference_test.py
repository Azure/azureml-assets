...
"""Tests running a sample job in the minimal 22.04 py39 cpu environment."""
import os
import time
...
def test_minimal_cpu_inference():
    """Tests a sample job using minimal 22.04 py39 cpu as the environment."""
    ...
    env_docker_context = Environment(
        ...
        description="minimal 22.04 py39 cpu inference environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the minimal 22.04 py39 cpu inference curated environment",
