...
"""Tests running a sample job in the minimal ubuntu22.04 py39 gpu environment."""
import os
import time
...
def test_minimal_cpu_inference():
    """Tests a sample job using minimal ubuntu22.04 py39 gpu as the environment."""
    ...
    env_docker_context = Environment(
        ...
        description="minimal ubuntu22.04 py39 gpu inference environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the minimal ubuntu22.04 py39 gpu inference curated environment",
