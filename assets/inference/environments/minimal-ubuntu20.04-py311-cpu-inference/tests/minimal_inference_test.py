...
"""Tests running a sample job in the minimal 20.04 py311 cpu environment."""
import os
import time
...
def test_minimal_cpu_inference():
    """Tests a sample job using minimal 20.04 py311 cpu as the environment."""
    ...
    env_docker_context = Environment(
        ...
        description="minimal 20.04 py311 cpu inference environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the minimal 20.04 py311 cpu inference curated environment",
