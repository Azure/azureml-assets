...
class DocumentRetrievalEvaluator(EvaluatorBase):
    ...
    def __init__(
        ...
        *,
        ...
        :param ground_truth_label_min: Minimum ground truth label value.
        :type ground_truth_label_min: int
        :param ground_truth_label_max: Maximum ground truth label value.
        :type ground_truth_label_max: int
        :param ndcg_threshold: NDCG threshold for evaluation.
        :type ndcg_threshold: Optional[float]
        :param xdcg_threshold: XDCG threshold for evaluation.
        :type xdcg_threshold: Optional[float]
        :param fidelity_threshold: Fidelity threshold for evaluation.
        :type fidelity_threshold: Optional[float]
        :param top1_relevance_threshold: Top 1 relevance threshold.
        :type top1_relevance_threshold: Optional[float]
        :param top3_max_relevance_threshold: Top 3 max relevance threshold.
        :type top3_max_relevance_threshold: Optional[float]
        :param total_retrieved_documents_threshold: Total retrieved documents threshold.
        :type total_retrieved_documents_threshold: Optional[int]
        :param total_ground_truth_documents_threshold: Total ground truth documents threshold.
        :type total_ground_truth_documents_threshold: Optional[int]
        """
        super().__init__()
        self.k = 3
    ...
    def _compute_ndcg(
        ...
        """Calculate NDCG (Normalized Discounted Cumulative Gain) for the top K documents retrieved from a query.
