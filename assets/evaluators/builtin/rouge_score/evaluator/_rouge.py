...
class RougeScoreEvaluator(EvaluatorBase):
    ...
    def __init__(
        ...
        *,
        ...
        :param rouge_type: The type of ROUGE evaluation to perform.
        :type rouge_type: RougeType
        :param precision_threshold: The precision threshold for evaluation.
        :type precision_threshold: float
        :param recall_threshold: The recall threshold for evaluation.
        :type recall_threshold: float
        :param f1_score_threshold: The F1 score threshold for evaluation.
        :type f1_score_threshold: float
        """
