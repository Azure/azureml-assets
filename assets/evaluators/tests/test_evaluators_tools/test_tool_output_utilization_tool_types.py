...
"""
Tool type tests for Tool Output Utilization Evaluator.
...
class TestToolOutputUtilizationToolTypes(BaseToolTypeEvaluatorTest):
    """
    Tool type tests for ToolOutputUtilizationEvaluator.
