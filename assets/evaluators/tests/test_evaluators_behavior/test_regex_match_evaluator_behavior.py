...
class TestRegexMatchEvaluatorBehavior(BaseCodeEvaluatorRunner):
    ...
    def test_json_response_extraction_failure_falls_back_to_empty_response(self):
        """If message extraction raises, it is treated as an empty response instead of crashing."""
        import json
        ...
        # Falls back to an empty string rather than the raw JSON-encoded response.
        assert result == ""
