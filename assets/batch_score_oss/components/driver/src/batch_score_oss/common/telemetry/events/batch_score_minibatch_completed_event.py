...
class BatchScoreMinibatchCompletedEvent(BatchScoreEvent):
    ...
    """How many rows were text-only in the minibatch?"""
    input_row_text_count: int = field(init=True, default=None)

    """How many rows were image-only in the minibatch?"""
    input_row_image_count: int = field(init=True, default=None)

    """How many rows were text and image in the minibatch?"""
    input_row_text_image_count: int = field(init=True, default=None)
