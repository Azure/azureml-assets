...
def main():
    ...
    if args.model_name == Dinov2_Modelname and (args.apply_deepspeed is True or args.apply_ort is True):
        err_msg = f"apply_deepspeed or apply_ort is not yet supported for {Dinov2_Modelname}. " \
