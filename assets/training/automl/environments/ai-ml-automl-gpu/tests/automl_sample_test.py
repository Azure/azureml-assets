...
"""Smoke tests running a job in the ai-ml-automl-gpu environment."""
...
def test_azure_ai_ml_automl():
    """Tests a sample job using ai-ml-automl-gpu as the environment."""
    ...
    env_name = "ai-ml-automl-gpu"

    env_docker_context = Environment(
        build=BuildContext(path=this_dir / BUILD_CONTEXT),
        name="ai-ml-automl-gpu",
        description="ai-ml-automl-gpu environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the ai-ml-automl-gpu curated environment",
