...
"""Smoke tests running a job in the ai-ml-automl-dnn-text-gpu-ptca environment."""
...
def test_azure_ai_ml_automl():
    """Tests a sample job using ai-ml-automl-dnn-text-gpu-ptca as the environment."""
    ...
    env_name = "ai-ml-automl-dnn-text-gpu-ptca"

    env_docker_context = Environment(
        build=BuildContext(path=this_dir / BUILD_CONTEXT),
        name="ai-ml-automl-dnn-text-gpu-ptca",
        description="ai-ml-automl-dnn-text-gpu-ptca environment created from a Docker context.",
    )
