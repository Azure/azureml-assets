...
"""Smoke tests running a job in the ai-ml-automl-dnn-gpu environment."""
...
def test_azure_ai_ml_automl():
    """Tests a sample job using ai-ml-automl-dnn-gpu as the environment."""
    ...
    env_name = "ai-ml-automl-dnn-gpu"

    env_docker_context = Environment(
        build=BuildContext(path=this_dir / BUILD_CONTEXT),
        name="ai-ml-automl-dnn-gpu",
        description="ai-ml-automl-dnn-gpu environment created from a Docker context.",
    )
    ...
    job = command(
        ...
        description="A test run of the ai-ml-automl-dnn-gpu curated environment",
