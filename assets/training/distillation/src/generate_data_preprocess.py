...
from common.api_connection_helper import get_target_from_connection
...
def data_import(args: Namespace):
    ...
    if teacher_model_connection_name:
        try:
            teacher_model_endpoint_url = get_target_from_connection(teacher_model_connection_name)
        except Exception as e:
