...
"""Wrapper code for running AutoML Many Models PRS inference run."""
import os
...
from azureml.train.automl.runtime._solution_accelorators.pipeline_run.steps.many_models.mm_inference_v2 import \
    MMInferenceWrapperV2  # noqa: E402
...
def run(mini_batches):
    ...
    if runtime_wrapper is None:
        runtime_wrapper = MMInferenceWrapperV2()
