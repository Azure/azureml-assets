...
# ---------------------------------------------------------
"""Wrapper code for HTS data aggregation."""
...
from azureml.train.automl.runtime._solution_accelorators.pipeline_run.steps.hts.hts_data_aggregation_v2 import \
    HTSDataAggregationWrapperV2  # noqa: E402
...
def run(mini_batches):
    """Run method of data aggregation."""
    ...
    if runtime_wrapper is None:
        runtime_wrapper = HTSDataAggregationWrapperV2(Path(__file__).parent.absolute())
