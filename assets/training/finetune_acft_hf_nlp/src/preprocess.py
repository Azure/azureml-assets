...
from utils.common.component_run_utils import ComponentRunUtils
from utils.common.env_utils import set_up_environment
from utils.common.ft_config_utils import FtConfig
...
def main():
    ...
    set_logging_parameters(
        ...
        acft_custom_dimensions={
            ...
            LoggingLiterals.COMPONENT_NAME: ComponentRunUtils().get_component_asset_id()
        },
    ...
    # set-up environment
    ft_conf_obj = FtConfig("finetune_config.yaml")
    uninstalls, installs = ft_conf_obj.fetch_environment_setup()
    set_up_environment(
