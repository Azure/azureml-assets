...
DEFAULT_DEEPSPEED_STAGE2_CONFIG = os.path.join(os.path.dirname(os.path.abspath(__file__)), "zero2.json")
DEFAULT_DEEPSPEED_STAGE3_CONFIG = os.path.join(os.path.dirname(os.path.abspath(__file__)), "zero3.json")
