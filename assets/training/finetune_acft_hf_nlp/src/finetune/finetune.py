...
def get_parser():
    ...
    parser.add_argument("--finetune_in_8bit", type=str2bool, default="false", help="enable 8 bit training")
    parser.add_argument("--finetune_in_4bit", type=str2bool, default="false", help="enable 4 bit training")
