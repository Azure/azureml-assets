...
from model_converter_utils import load_model, load_tokenizer, copy_tokenizer_files_to_model_folder
...
class ModelConverter(ABC):
    ...
    def copy_finetune_config(self, src_model_path: str, dst_model_path: str):
        ...
        finetune_config_path = Path(src_model_path, SaveFileConstants.ACFT_CONFIG_SAVE_PATH)
...
class PyTorch_to_MlFlow_ModelConverter:
    ...
    def set_mlflow_model_parameters(self, model):
        ...
        self.metadata = getattr(self.component_args, ModelSelectorConstants.MODEL_METADATA, {})
        ...
        mlflow_infer_params_file_path = str(Path(
            self.ft_pytorch_model_path, MLFlowHFFlavourConstants.INFERENCE_PARAMS_SAVE_NAME_WITH_EXT
        ))
        ...
        self.py_code_files = get_model_custom_code_files(self.ft_pytorch_model_path, model)
