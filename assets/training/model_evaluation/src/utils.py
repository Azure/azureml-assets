...
def get_sample_data_and_column_names(args):
    ...
    if task in constants.IMAGE_TASKS:
        ...
        sample_data, _ = read_model_prediction_data(data, task, input_column_names, label_column_name)

        logger.info("v2 {} {}".format(input_column_names, label_column_name))

    else:
        sample_data, _ = read_model_prediction_data(data, task, [], "", nrows=1)
