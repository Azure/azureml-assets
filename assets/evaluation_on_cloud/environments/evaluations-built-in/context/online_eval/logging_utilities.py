...
from azureml.automl.core.shared.logging_utilities import (
    _CustomStackSummary, mark_path_as_loggable
)
...
import constants
from error_definitions import OnlineEvalInternalError
...
class CustomDimensions:
    ...
    def __init__(self,
                 ...
                 component_version=TelemetryConstants.COMPONENT_DEFAULT_VERSION,
    ...
    def wrap(func):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                error = OnlineEvalInternalError
                exception = get_azureml_exception(AzureMLException, error, e,
