...
# TODO: uncomment when FAD command components are ready
# @pytest.fixture(scope="session", autouse=True)
...
# TODO: uncomment when PD command components are ready
# @pytest.fixture(scope="session", autouse=True)
...
# TODO: uncomment when DQ command components are ready
# @pytest.fixture(scope="session", autouse=True)
