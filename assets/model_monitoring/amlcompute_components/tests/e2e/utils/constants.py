...
COMPONENT_NAME_DATA_DRIFT_SIGNAL_MONITOR = "data_drift_signal_monitor_command"
COMPONENT_NAME_PREDICTION_DRIFT_SIGNAL_MONITOR = "prediction_drift_signal_monitor_command"
COMPONENT_NAME_DATA_QUALITY_SIGNAL_MONITOR = "data_quality_signal_monitor_command"
COMPONENT_NAME_FEATURE_ATTRIBUTION_DRIFT_SIGNAL_MONITOR = (
    "feature_attribution_drift_signal_monitor_command"
)
COMPONENT_NAME_CREATE_MANIFEST = "model_monitor_create_manifest_command"
COMPONENT_NAME_MDC_PREPROCESSOR = "model_data_collector_preprocessor_command"
COMPONENT_NAME_METRIC_OUTPUTTER = "model_monitor_metric_outputter_command"
COMPONENT_NAME_DATA_JOINER = "model_monitor_data_joiner_command"
COMPONENT_NAME_GENERATION_SAFETY_QUALITY_SIGNAL_MONITOR = 'generation_safety_quality_signal_monitor_command'
