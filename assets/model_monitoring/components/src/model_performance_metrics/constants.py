...
class ErrorStrings:
    ...
    InvalidGroundTruthColumnNameCodeGen = "The format for the label column name in code generation should follow the " \
                                          "pattern: '<label_col_name>,<test_case_col_name>'. Either <label_col_name> " \
                                          "or <test_case_col_name> can be empty, but at least one of them must be set."
