...
def _submit_generation_safety_signal_monitor_job(ml_client, get_component, target_data):
    ...
    def _gen_safety_model_monitor_e2e():
        dd_model_monitor_output = generation_safety_model_monitor(
            ...
            workspace_connection_arm_id="/subscriptions/e0fd569c-e34a-4249-8c24-e8d723c7f054/resourceGroups/hawestra-rg/providers/Microsoft.MachineLearningServices/workspaces/hawestra-ws/connections/rai_dev_connection"
        )
