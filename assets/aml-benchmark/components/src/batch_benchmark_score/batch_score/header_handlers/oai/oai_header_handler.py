...
class OAIHeaderHandler(HeaderHandler):
    ...
    def get_headers(self, additional_headers: "dict[str, any]" = None) -> "dict[str, any]":
        ...
        online_endpoint = AOAIOnlineEndpoint(
            workspace_name=None, resource_group=None, subscription_id=None, online_endpoint_model=None,
            endpoint_name=self._endpoint_name, deployment_name=None, sku=None, location=None
        )
