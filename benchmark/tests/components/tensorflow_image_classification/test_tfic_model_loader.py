...
from tensorflow_benchmark.classification.model import (
    MODEL_ARCH_LIST,
    get_model_metadata,
    load_model,
)
...
def test_model_loader(model_arch):
    """Tests src/components/tensorflow_benchmark/classification/model/"""
    ...
    model = load_model(model_arch, output_dimension=3)
...
def test_model_loader_failure():
    ...
    with pytest.raises(NotImplementedError):
        load_model("not_a_model", output_dimension=3)
