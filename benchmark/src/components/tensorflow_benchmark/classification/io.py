...
class ImageFolderHelper:
    """Helps locating images and masks for training a classification model"""
...
class ImageFolderDataset(ImageFolderHelper):
    ...
    def dataset(self, input_size=160):
        ...
        with tensorflow.device("CPU"):
            ...
            _loading_function = (
                lambda i, m: ImageFolderDataset.loading_function(
