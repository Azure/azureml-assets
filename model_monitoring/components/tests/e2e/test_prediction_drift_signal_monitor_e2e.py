...
def _submit_prediction_drift_model_monitor_job(ml_client, get_component, experiment_name, baseline_data, target_data):
    prediction_drift_signal_monitor = get_component(COMPONENT_NAME_PREDICTION_DRIFT_SIGNAL_MONITOR)
    ...
    def _prediction_drift_signal_monitor_e2e():
        ...
        return {"signal_output": prediction_drift_signal_monitor_output.outputs.signal_output}
