...
def _submit_data_drift_and_create_manifest_job(ml_client: MLClient, get_component, experiment_name, baseline_data, target_data):
    ...
    def _create_manifest_e2e():
        ...
        return {"model_monitor_metrics_output": create_manifest_output.outputs.model_monitor_metrics_output}

    pipeline_job = _create_manifest_e2e()
    pipeline_job.outputs.model_monitor_metrics_output = Output(type="uri_folder", mode="direct")
