...
COMPONENT_NAME_FEATURE_ATTRIBUTION_DRIFT_SIGNAL_MONITOR = "feature_attribution_drift_signal_monitor_spark"
...
COMPONENT_NAME_GENERATION_SAFETY_QUALITY_SIGNAL_MONITOR = 'generation_safety_quality_signal_monitor_spark'
...
DATA_ASSET_IRIS_PREPROCESSED_MODEL_INPUTS_NO_DRIFT = 'azureml:iris_preprocessed_model_inputs_no_drift:1'
DATA_ASSET_IRIS_PREPROCESSED_MODEL_OUTPUTS_NO_DRIFT = 'azureml:iris_preprocessed_model_outputs_no_drift:1'
DATA_ASSET_IRIS_PREPROCESSED_MODEL_INPUTS_OUTPUTS_NO_DRIFT = 'azureml:iris_preprocessed_model_inputs_outputs_no_drift:1'
...
DATA_ASSET_IRIS_MODEL_INPUTS_OUTPUTS_WITH_NO_DRIFT = 'azureml:iris_model_inputs_outputs_no_drift:1'

# Groundedness target dataset as a MLTable.
DATA_ASSET_GROUNDEDNESS_PREPROCESSED_TARGET_DATA = 'azureml:groundedness_preprocessed_target_small:1'
