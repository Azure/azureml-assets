...
def update_asset(asset_config: assets.AssetConfig,
    ...
    if release_dir.exists():
        ...
        if pending_release and ((not auto_version and main_version != release_version) or skip_unreleased) and release_asset_config.type is not assets.AssetType.COMPONENT:
