...
class _LoggerFactory:
    ...
    def get_logger(name, verbosity=logging.DEBUG):
        ...
        if not _LoggerFactory._found_handler(logger,
    ...
    def _try_get_version_info():
        model_name_exists = _LoggerFactory._module_name is not None
        if model_name_exists and _LoggerFactory._module_version is not None:
            return
